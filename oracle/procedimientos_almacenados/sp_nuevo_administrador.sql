/*
Procedimiento almacenado: sp_nuevo_administrador
...
create or replace procedure sp_nuevo_administrador(
...
begin
    ...
    SP_CREAR_ADMINISTRADOR(IN_FK_USUARIO  => var_usuario_id /*IN NUMBER*/,
                           OUT_INSERTED_ID  => var_administrador_id /*OUT NUMBER*/);

    if var_administrador_id = -1 then
        RAISE_APPLICATION_ERROR(-20000, 'ERROR: Se ha producido un error al intentar crear un administrador.');
    end if;
