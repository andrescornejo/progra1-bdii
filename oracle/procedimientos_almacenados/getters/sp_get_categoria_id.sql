/*
Procedimiento almacenado: sp_get_categoria_id
...
create or replace procedure sp_get_categoria_id(
...
select ca.categoria_id into out_selected_id 
from categoria ca where ca.nombre = in_nombre_cat;
